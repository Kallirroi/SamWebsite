...
class App extends Component {
  ...
  componentDidMount() {
    ...
    let tokenSamtous = "40791457.8281038.b0f0b621466045ed90d9602757e6abe6";
    let instaURL = "https://api.instagram.com/v1/users/self/media/recent/?access_token="+tokenSamtous+"&callback=?";
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <div className="Footer"><a href="https://kalliretzepi.com" target="_blank">Kalli</a> made this website</div>
      </div>
    );
  }
}
